...
namespace SyemaTest.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,DepartmentId,Email")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,DepartmentId,Email")] Student student)
        {
            if (ModelState.IsValid)
            {
